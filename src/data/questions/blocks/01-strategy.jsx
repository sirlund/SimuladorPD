...
export const strategy_questions = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Big Bang Rewrite:** Apoyas la reescritura total. El CTO garantiza que pasar a React permitirá contratar talento un 20% más económico y acelerar el hiring. Aceptas el dolor a corto plazo para ganar eficiencia financiera y técnica a largo plazo.", score: 1, type: "Optimismo técnico", decisionSummary: "Apoyaste reescritura big bang de 6 meses." },
      { id: 'B', text: "**Strangler Fig Pattern:** Propones migrar pantalla por pantalla, permitiendo coexistencia. Priorizas vistas con alto tráfico para validar valor incrementalmente. Modernizas el stack progresivamente sin detener el flujo de revenue.", score: 5, type: "Lead (Incremental De-Risking)", decisionSummary: "Propusiste migración incremental con Strangler Fig." },
      { id: 'C', text: "**Feature Prioritization:** Sugieres posponer el refactor y enfocarse en revenue. Si el código actual funciona, no lo toques. Maximizas el retorno financiero inmediato exprimiendo el sistema legacy un año más.", score: 3, type: "Cortoplacista", decisionSummary: "Pospusiste modernización para exprimir el legacy." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Code Freeze Total:** Negocias una pausa operativa argumentando que la V2 acelerará todo el desarrollo futuro en un 30%. Inviertes tiempo ahora para ganar velocidad después, asegurando una base de código limpia.", score: -1, type: "Big Bang / Incorrect", decisionSummary: "Propusiste code freeze paralizando el roadmap comercial." },
      { id: 'B', text: "**Versionado Coexistente:** Publicas V2 como librería paralela y migras progresivamente (feature por feature). Aceptas convivir con deuda técnica temporal (código duplicado) para no bloquear el roadmap comercial.", score: 5, type: "Lead / Correct", decisionSummary: "Publicaste V2 en paralelo migrando incrementalmente." },
      { id: 'C', text: "**Forward Only:** Implementas V2 solo en proyectos nuevos y dejas lo viejo en V1 indefinidamente. Evitas el costo de migración y mantienes la velocidad máxima, asumiendo la fragmentación como una realidad operativa.", score: 1, type: "Fragmentación / Incorrect", decisionSummary: "Dejaste V1 legacy permanente creando fragmentación." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Análisis de Proceso (Post-Mortem):** Enfocas la conversación en que el fallo fue sistémico (QA y Dev también aprobaron). Propones revisar los protocolos de release para asegurar que no vuelva a suceder, distribuyendo la responsabilidad.", score: 1, type: "Defensivo / Incorrect", decisionSummary: "Distribuiste culpa en vez de asumir liderazgo." },
      { id: 'B', text: "**Extreme Ownership:** Asumes la responsabilidad pública total inmediatamente. Presentas el plan de reversión (ya ejecutado) y la estrategia de comunicación al usuario. Desarmas el ataque tomando control de la solución.", score: 5, type: "Lead (Liderazgo en Crisis)", decisionSummary: "Asumiste responsabilidad total y presentaste la solución." },
      { id: 'C', text: "**Gestión Centralizada (Legal Shield):** Remites todas las consultas a Legal y PR para asegurar un mensaje unificado y proteger a la empresa de responsabilidad civil. Sigues el protocolo corporativo de gestión de crisis al pie de la letra.", score: -1, type: "Burocrático / Abdica", decisionSummary: "Te escondiste tras Legal abdicando liderazgo técnico." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Strategic Silence:** Mantienes el curso ignorando a los trolls. Asumes que la 'mayoría silenciosa' está satisfecha y que responder solo alimentará el algoritmo y dará más visibilidad a la crítica negativa.", score: 1, type: "Negligente", decisionSummary: "Ignoraste la crisis esperando que pasara sola." },
      { id: 'B', text: "**Corrección y Transparencia:** Publicas un update reconociendo el error, simplificas la UI inmediatamente y respondes reviews clave. Priorizas detener la hemorragia de confianza sobre el orgullo corporativo.", score: 5, type: "Lead (Escucha y Actúa)", decisionSummary: "Reconociste el error y simplificaste la UI inmediatamente." },
      { id: 'C', text: "**Brand Defense:** Publicas un comunicado oficial explicando que los cambios cumplen con los términos de servicio y educas al usuario sobre el valor del nuevo modelo. Defiendes la postura de la empresa ante la desinformación.", score: 1, type: "Sordo (Tone-deaf)", decisionSummary: "Defendiste el dark pattern educando al usuario." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Gestión de Expectativas:** Reprogramas la demo argumentando que prefieres mostrar el build final con la calidad que merecen. Priorizas la perfección de la presentación sobre la urgencia del calendario.", score: 1, type: "Gestión de Expectativas", decisionSummary: "Reprogramaste el demo con inversionistas en camino." },
      { id: 'B', text: "**Demo en Producción:** Usas el ambiente live con usuarios reales y un script ajustado. Asignas monitoreo en tiempo real y demuestras confianza total en el producto que ya está en el mercado.", score: 5, type: "Lead (Improvisa con Confianza)", decisionSummary: "Improvisaste demo en producción con confianza." },
      { id: 'C', text: "**Safe Mode (Slides):** Cancelas el live demo y presentas slides con capturas y videos pregrabados de alta fidelidad. Eliminas cualquier riesgo de error técnico durante la presentación clave.", score: 3, type: "Backup Plan (Menos impacto)", decisionSummary: "Presentaste slides en vez de demo live." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Contraoferta Agresiva:** Igualas o superas el salario de FAANG para retenerlo esas 8 semanas críticas. Entiendes que el costo de perder el deadline es mayor que el aumento salarial temporal necesario para cerrar el proyecto.", score: -1, type: "Retention Play (Precedente peligroso)", decisionSummary: "Contraofertaste con aumento creando precedente salarial." },
      { id: 'B', text: "**Knowledge Transfer Intensivo:** Dedicas sus 2 semanas exclusivamente a documentación, Looms y pair design con el equipo. Sacrificas features nuevas para maximizar la captura de contexto antes de que salga por la puerta.", score: 5, type: "Lead (Minimiza Pérdida)", decisionSummary: "Maximizaste knowledge transfer en las 2 semanas." },
      { id: 'C', text: "**Staff Augmentation:** Contratas un senior freelance urgente para que haga shadowing inmediato. Buscas mantener la velocidad de producción sumando manos expertas que trabajen en paralelo.", score: 1, type: "Costoso (Curva de aprendizaje)", decisionSummary: "Contrataste freelance urgente ignorando curva de contexto." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Wartime Sprint:** Movilizas al equipo bajo una misión crítica: cerrar el deal de $800K. Reduces el alcance a un MVP funcional y enfocas el 100% de la energía en cumplir la promesa comercial que impulsa el crecimiento.", score: -1, type: "Hustle Culture (Burnout Factory)", decisionSummary: "Aceptaste plazo imposible forzando crunch al equipo." },
      { id: 'B', text: "**Renegociación Estructurada:** Ventas y Product ofrecen un plan de entrega por fases (Beta en 3 semanas, Full en 3 meses). Aportas transparencia y profesionalismo para alinear la promesa con la viabilidad técnica.", score: 5, type: "Lead (Realismo Profesional)", decisionSummary: "Renegociaste entrega por fases con el cliente." },
      { id: 'C', text: "**No-Code Bridge:** Usas Zapier/Make para cumplir la promesa funcionalmente 'por detrás'. Entregas valor inmediato al cliente cumpliendo el plazo, mientras Ingeniería construye la solución real en paralelo.", score: 1, type: "Solución Temporal", decisionSummary: "Usaste no-code como parche para cliente Enterprise." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Risk Management First:** Aceptas el disclaimer tal cual. En industrias reguladas, la protección contra demandas (Liability) tiene jerarquía sobre la optimización de conversión. Es el costo de hacer negocios.", score: -1, type: "Risk Averse (UX destruida)", decisionSummary: "Aceptaste disclaimer de 2 párrafos destruyendo UX." },
      { id: 'B', text: "**Co-Design Workshop:** Reúnes a Legal y Product para diseñar alternativas (tooltips, progressive disclosure) que cumplan el requisito legal sin romper la UI. Transformas la demanda legal en un reto de diseño compartido.", score: 5, type: "Lead (Facilitador de Soluciones)", decisionSummary: "Facilitaste co-design entre Legal y Product." },
      { id: 'C', text: "**Technical Workaround:** Muestras el disclaimer solo una vez (cookie) y lo ocultas después. Reduces la fricción para el usuario recurrente mientras técnicamente cumples con mostrar el texto legal.", score: 1, type: "Workaround (Riesgoso)", decisionSummary: "Implementaste workaround técnico arriesgando compliance." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Visionary Scaling:** Apoyas la transición a plataforma. Argumentas que capturar el ecosistema temprano es la única forma de construir un 'moat' defensivo contra competidores, posicionando a la empresa para crecimiento exponencial.", score: -1, type: "Think Big (Premature Scaling)", decisionSummary: "Apoyaste plataforma sin PMF sólido." },
      { id: 'B', text: "**Sequencing Strategy:** Argumentas que 'primero profundidad, luego amplitud'. Deben dominar el caso de uso core (Product-Market Fit sólido) antes de abrir la superficie de ataque como plataforma.", score: 5, type: "Lead (Secuenciación Estratégica)", decisionSummary: "Argumentaste secuenciar: primero profundidad, luego amplitud." },
      { id: 'C', text: "**Compromiso Híbrido:** Propones lanzar solo las APIs públicas como MVP de plataforma, posponiendo el marketplace. Avanzas en la visión estratégica sin comprometer todos los recursos de ingeniería de inmediato.", score: 1, type: "Compromiso (Diluye el foco)", decisionSummary: "Propusiste APIs sin resolver bugs del core." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Churn Audit:** Analizas si realmente estás perdiendo clientes por esas features específicas. Usas evidencia de ventas perdidas (o la falta de ella) para filtrar el ruido y priorizar solo lo que impacta el negocio.", score: 5, type: "Lead (Evidence-Based)", decisionSummary: "Analizaste churn real antes de reaccionar al competidor." },
      { id: 'B', text: "**Market Parity:** Copias las 3 features más visibles para neutralizar la ventaja de marketing del competidor. Aseguras que tu tabla de precios se vea competitiva ante nuevos prospectos.", score: 1, type: "Defensivo (Feature parity race)", decisionSummary: "Copiaste features del competidor sin evidencia de impacto." },
      { id: 'C', text: "**Strategic Focus:** Ignoras al competidor completamente para mantener el foco en tu roadmap original. Confías en tu visión diferenciada y evitas distraer al equipo con reacciones impulsivas.", score: 1, type: "Dogmático (Puede ser arriesgado)", decisionSummary: "Ignoraste al competidor dogmáticamente." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Decentralized Agility:** Mantienes los sistemas separados. Permites que cada equipo optimice para su tecnología y velocidad sin dependencias externas, priorizando la autonomía de los squads.", score: 1, type: "Silos (Duplicación eterna)", decisionSummary: "Mantuviste 3 sistemas separados perpetuando duplicación." },
      { id: 'B', text: "**Federated Architecture (Core + Extensions):** Creas una librería base compartida (Tokens, Primitivos) y permites extensiones específicas por producto. Balanceas la eficiencia central con la flexibilidad local.", score: 5, type: "Lead (Shared Foundation)", decisionSummary: "Creaste arquitectura federada con core compartido." },
      { id: 'C', text: "**Unified Monolith:** Implementas un único 'One System to Rule Them All'. Garantizas consistencia visual absoluta en todos los puntos de contacto de la marca forzando la adopción de un estándar único.", score: 3, type: "Rígido (No refleja realidad)", decisionSummary: "Forzaste monolito único ignorando necesidades locales." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Visionary Leadership:** Mantienes el curso. 'La gente odia el cambio, pero amará la V2'. Confías en que la superioridad del nuevo producto eventualmente convertirá a los detractores.", score: -1, type: "Steve Jobs Trap (Churn garantizado)", decisionSummary: "Ignoraste a power users confiando en la superioridad de V2." },
      { id: 'B', text: "**Responsive Roadmap:** Validar qué features faltantes son críticas y comprometerse públicamente a reintroducirlas en V2 a corto plazo. Muestras empatía y flexibilidad sin revertir la migración.", score: 5, type: "Lead (Responsive Migration)", decisionSummary: "Te comprometiste a reintroducir features críticas en V2." },
      { id: 'C', text: "**Legacy Access:** Mantienes la V1 accesible indefinidamente para quienes no quieran migrar. Respetas la preferencia del usuario y evitas el churn inmediato manteniendo ambas opciones.", score: 1, type: "Parche (Duplica mantenimiento)", decisionSummary: "Mantuviste V1 indefinidamente duplicando mantenimiento." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Clean Break:** Comunicas la fecha de cierre con transparencia y antelación. Permites que la empresa enfoque todos sus recursos en el futuro, eliminando distracciones legacy de forma definitiva.", score: -1, type: "Efficiency (Churn 100%)", decisionSummary: "Comunicaste cierre limpio perdiendo 500 usuarios." },
      { id: 'B', text: "**Retention Migration:** Asignas un equipo 'Concierge' para construir los gaps críticos y asistir la migración. Tratas el sunset como un proyecto de retención de revenue, no solo de cierre técnico.", score: 5, type: "Lead (Retención Activa)", decisionSummary: "Asignaste equipo concierge para retención activa." },
      { id: 'C', text: "**Financial Compensation:** Ofreces descuentos agresivos (50% off) en el nuevo producto. Utilizas incentivos económicos para suavizar la fricción de la pérdida funcional.", score: 1, type: "$$$ (No resuelve el gap)", decisionSummary: "Ofreciste descuento sin resolver el gap funcional." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Process Defense:** Confrontas la violación del proceso para proteger la integridad del sistema. Estableces límites claros sobre la gobernanza de diseño, independientemente del cargo.", score: 1, type: "Valiente / Incorrect", decisionSummary: "Confrontaste al CEO por violar el proceso de diseño." },
      { id: 'B', text: "**Political Judo (Validate & Redirect):** Agradeces el 'prototipo de alta fidelidad' y propones una sesión de refinamiento técnico. Validas su aporte pero reinsertas el trabajo en el flujo de calidad normal.", score: 5, type: "Lead (Manage Up)", decisionSummary: "Validaste al CEO y reinsertaste su diseño en el proceso." },
      { id: 'C', text: "**Silent Execution:** Implementas el diseño tal cual. El CEO es el stakeholder final y eliges tus batallas, priorizando la armonía política sobre la pureza del sistema.", score: 1, type: "Obediente / Incorrect", decisionSummary: "Implementaste el diseño del CEO sin validación." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Quality & Craft Argument:** Explicas cómo el sistema asegura consistencia visual y excelencia de marca. Apelas al valor intangible de la calidad percibida como diferenciador de mercado.", score: -1, type: "Craft Argument (No convence)", decisionSummary: "Argumentaste calidad visual sin métricas financieras." },
      { id: 'B', text: "**Efficiency Calculator:** Presentas el ahorro en horas de ingeniería (Velocity). 'Cada componente ahorra 4h. 100 componentes = 2 FTEs liberados'. Traduces consistencia en dinero ahorrado.", score: 5, type: "Lead (Business Case)", decisionSummary: "Presentaste ROI en términos de horas y FTEs ahorrados." },
      { id: 'C', text: "**Industry Standard:** Muestras que Uber, Airbnb y Google tienen equipos dedicados. Argumentas que para competir al mismo nivel, la empresa debe adoptar las mejores prácticas de la industria.", score: 1, type: "Social Proof (Débil)", decisionSummary: "Usaste social proof de FAANG sin métricas propias." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Skill Expansion:** Organizas capacitación en React para el equipo. Intentas cerrar la brecha técnica para alinear al equipo con las expectativas modernas de la ingeniería.", score: 1, type: "Appeasement (Distrae del core)", decisionSummary: "Capacitaste diseñadores en código distrayendo del core." },
      { id: 'B', text: "**Role Clarity:** Defiendes la especialización: 'El valor del diseño es resolver el problema correcto, el código es la implementación'. Reafirmas que la división de trabajo genera mayor calidad en ambas puntas.", score: 5, type: "Lead (Claridad de roles)", decisionSummary: "Defendiste la especialización y claridad de roles." },
      { id: 'C', text: "**Structural Hiring:** Propones contratar un 'Design Engineer' puente. Resuelves la fricción operativa con un rol híbrido sin forzar a los diseñadores actuales a cambiar su perfil.", score: 3, type: "Estructural (Parche)", decisionSummary: "Propusiste contratar Design Engineer como parche." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Meritocracia Ciega:** Evalúas a todos bajo el mismo estándar de skills, sin importar el origen. Construyes el mejor equipo posible, asumiendo el costo de despedir a gente leal de tu propio equipo original.", score: 5, type: "Lead (Doloroso pero justo)", decisionSummary: "Evaluaste a todos bajo el mismo estándar de mérito." },
      { id: 'B', text: "**Legacy Protection:** Priorizas a tu equipo original porque ya conocen la cultura y sistemas. Aseguras la continuidad operativa y proteges a tu gente, minimizando el riesgo de onboarding.", score: 1, type: "Tribal (Injusto)", decisionSummary: "Protegiste a tu equipo original por lealtad tribal." },
      { id: 'C', text: "**Diplomatic Balance:** Propones un mix 50/50 para integrar ambas culturas. Buscas la paz política y envías una señal de unidad, equilibrando la representación de ambas empresas.", score: 3, type: "Diplomático (Evita meritocracia)", decisionSummary: "Propusiste mix diplomático evitando evaluar mérito." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Interactive Guidance:** Implementas un 'Plan Finder Quiz' que recomienda la opción ideal. Ayudas al usuario a navegar la complejidad mediante personalización asistida.", score: 1, type: "Fricción adicional", decisionSummary: "Agregaste quiz en vez de simplificar la oferta." },
      { id: 'B', text: "**Choice Architecture (Good-Better-Best):** Reduces a 3 opciones claras y ocultas los detalles técnicos. Aplicas psicología conductual para eliminar la parálisis por análisis y facilitar la comparación.", score: 5, type: "Lead (Paradox of Choice)", decisionSummary: "Simplificaste a 3 opciones aplicando Choice Architecture." },
      { id: 'C', text: "**Social Nudge:** Agregas etiquetas de 'Más Popular' para guiar la atención. Utilizas la prueba social para influenciar la decisión sin necesidad de reestructurar la oferta comercial.", score: 3, type: "Nudge (Parcial)", decisionSummary: "Agregaste nudge sin simplificar la estructura." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Parallel Prototyping:** Divides recursos para explorar ambas visiones. Generas tangibles para que la discusión sea sobre prototipos reales y no sobre ideas abstractas.", score: 3, type: "Neutral (Desperdicia recursos)", decisionSummary: "Dividiste recursos explorando ambas visiones." },
      { id: 'B', text: "**Strategic Freeze (Forzar Alineación):** Detienes el diseño y facilitas un workshop de decisión con data. Te niegas a quemar recursos hasta que haya una estrategia unificada clara.", score: 5, type: "Lead (Lidera hacia arriba)", decisionSummary: "Detuviste el diseño hasta forzar alineación de founders." },
      { id: 'C', text: "**Side Taking:** Apuestas por la visión que consideras ganadora (B2B). Aportas tu criterio experto para desbloquear al equipo y avanzar en una dirección concreta.", score: 1, type: "Valiente (Suicida)", decisionSummary: "Tomaste lado en la guerra de founders." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Chain of Command Override:** Buscas audiencia con el CEO para exponer el riesgo. Actúas como guardián de la cultura de producto saltando la jerarquía temporal.", score: 3, type: "Valiente (Riesgoso)", decisionSummary: "Saltaste la jerarquía para escalar al CEO." },
      { id: 'B', text: "**Financial Translation:** Conectas cada iniciativa de diseño con métricas financieras (Churn, Conversión). Hablas el idioma del CFO para validar la inversión en diseño como motor de eficiencia.", score: 5, type: "Lead (Bridge de lenguajes)", decisionSummary: "Tradujiste valor de diseño a métricas financieras." },
      { id: 'C', text: "**Compliance Mode:** Acatas las directrices temporales para evitar conflictos. Proteges al equipo manteniendo bajo perfil hasta que se contrate al nuevo VP permanente.", score: 3, type: "Supervivencia (Pierde valor)", decisionSummary: "Mantuviste bajo perfil esperando nuevo VP." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "**Política de Caducidad (TTL):** Estableces una regla de 'Time-to-Live' de 45 días para todo flag nuevo. Si no se limpia, el sistema alerta o bloquea deploys. Frenas el sangrado futuro inmediatamente.", score: 3, type: "Gobernanza Futura (No limpia el pasado)", decisionSummary: "Implementaste TTL sin limpiar flags existentes." },
      { id: 'B', text: "**Taxonomía de Flags:** Separas 'Release Flags' (temporales) de 'Permission Flags' (permanentes). Asignas un squad 'Janitor' al 20% de capacidad para eliminar flags temporales viejos en cada sprint, pagando la deuda progresivamente.", score: 5, type: "Lead (Limpieza Estructural)", decisionSummary: "Creaste taxonomía y squad janitor para limpiar deuda." },
      { id: 'C', text: "**Cleanup Sprint:** Autorizas la pausa de 1 mes. El riesgo de facturación es existencial. Un mes de roadmap perdido es preferible a perder la confianza de clientes Enterprise por errores aleatorios.", score: 1, type: "Reactivo (Drástico)", decisionSummary: "Pausaste roadmap 1 mes para cleanup sprint." }
    ],
