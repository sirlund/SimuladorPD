...
export const strategy_questions = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sprint de Choque: Aceptar el desafío como un 'Sprint de Guerra'. Reduces el alcance a un MVP funcional y enfocas al equipo 100% en esta entrega para cumplir la promesa comercial.", score: -1, type: "Burnout Factory (Deuda técnica brutal)" },
