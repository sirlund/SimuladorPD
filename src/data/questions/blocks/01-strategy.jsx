...
export const strategy_questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Escalación Burocrática: Elevas el conflicto al CEO pidiendo que arbitre entre los dos VPs. Detienes el trabajo hasta tener una resolución formal por escrito.", score: 2, type: "Burocrático" }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Forward Only + Narrativa: Aplicar nuevo sistema SOLO en features nuevas. Comunicar externamente que es una 'Brand Evolution' gradual. Aceptas la inconsistencia temporal para no frenar delivery ni arriesgar bugs.", score: 4, type: "Pragmático con spin de marketing (Apuesta arriesgada)" },
      { id: 'C', text: "Design Debt Sprint: Presentar business case (NPS = Churn) para pausar features no-críticas por 2 semanas y unificar las top 20 pantallas. Inversión de shock para recuperar confianza rápida.", score: 2, type: "Bold con riesgo político (Promesa difícil de cumplir)" }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Quality Gate: Rechazas cualquier diseño en Review que no presente mobile primero. Sin mobile, no se aprueba nada. Enforcement estricto.", score: 4, type: "Process enforcement con accountability (Autoridad directa)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Reconocimiento con Incentivo: Le ofreces un bonus de $2K por 'sprint heroico' y lo destacas en el All-Hands. Motivas el esfuerzo final pero validas la cultura de burnout.", score: 0, type: "Incentiva heroísmo tóxico" },
      ...
      { id: 'C', text: "Soporte con Recursos: Le asignas un Junior de asistente para tareas operativas. Ayuda con la carga manual, pero no resuelve la presión mental ni las horas de decisión crítica.", score: 4, type: "Mitigación (No resuelve raíz)" }
    ],
  ...
  // --- MIGRATED FROM INNOVATION BLOCK ---
  {
    ...
    options: [
      ...
      { id: 'C', text: "Oponerse completamente: Si el código actual funciona y es estable, no se toca. El negocio necesita features nuevas para vender, no refactoring invisible.", score: 4, type: "Cortoplacista (Acumula más deuda)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Code Freeze & Migración: Pausar features por 3 sprints para dedicar al equipo a la migración completa. Doloroso ahora, pero garantiza base limpia sin deuda futura.", score: 0, type: "Big Bang (Mata el roadmap)" },
      ...
      { id: 'C', text: "Fragmentación Táctica: Lanzar solo componentes nuevos en V2. Mantener los viejos sin cambios. Aceptas inconsistencia visual temporal para no bloquear.", score: 2, type: "Fragmentación (Dos sistemas eternos)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Defensa Compartida: Argumentas que el error fue sistémico (Ingeniería aprobó, QA validó). Propones revisar el proceso de testing para evitar futuros fallos.", score: 1, type: "Tóxico (Guerra Civil)" },
      ...
      { id: 'C', text: "Silencio Estratégico: Dejas que Legal y PR gestionen la comunicación externa para evitar responsabilidad legal personal. Te enfocas solo en el fix técnico.", score: 0, type: "Cobarde" }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Respuesta Defensiva: Publicas comunicado explicando que 'cumplimos con los términos'. Intentas educar al usuario sobre por qué el cambio es correcto.", score: 2, type: "Sordo (Tone-deaf)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Retrasar la reunión: Inventas una excusa corporativa ('Conflicto de agenda') para ganar 2 horas. Arriesgas la credibilidad si descubren la mentira, pero buscas la perfección técnica.", score: 1, type: "Mentiroso (Pierde credibilidad)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Contraoferta agresiva: Igualas o superas el salario de FAANG para retenerlo esas 8 semanas críticas. Compras tiempo pero sientas un precedente peligroso.", score: 0, type: "Desesperado (Insostenible)" },
      ...
      { id: 'C', text: "Contratar Freelance: Buscas un senior externo urgente para que trabaje en paralelo y aprenda observando. Es costoso y la curva de aprendizaje limitará su aporte.", score: 2, type: "Costoso (Curva de aprendizaje)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Forzar al equipo: Hacer un MVP sucio en 3 semanas con overtime. Cumples la promesa de ventas pero quemas al equipo y generas deuda técnica brutal.", score: 0, type: "Burnout Factory (Deuda técnica brutal)" },
      ...
      { id: 'C', text: "Solución No-Code: Usar Zapier/Make para cumplir la promesa funcionalmente mientras construyes la integración real. Es un parche creativo pero no escalable.", score: 2, type: "Parche Creativo (Funcional pero no escalable)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Aceptar y Escalar: Cumples el compromiso pero pides al CEO que prohíba esto a futuro. Es una medida reactiva que cierra la puerta después del error.", score: 3, type: "Reactivo (Cierra la puerta tarde)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Ensayo de UX: Le envías artículos académicos explicando por qué el chat es mala navegación. Es una respuesta teórica que probablemente será ignorada.", score: 2, type: "Académico" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sided with Legal: El riesgo legal es absoluto. Aceptas el disclaimer tal cual para evitar problemas regulatorios, aunque la UX sufra significativamente.", score: 0, type: "Rendición (UX destruida)" },
      ...
      { id: 'C', text: "Workaround Técnico: Mostrar el disclaimer solo en el primer uso y ocultarlo después. Asumes el riesgo de que Legal objete si hay una auditoría estricta.", score: 2, type: "Workaround (Legal puede objetar)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apoyar la visión de plataforma: Pensar en grande es clave. Iniciar la transición a plataforma ahora posicionará a la empresa como líder del mercado a largo plazo.", score: 0, type: "Visionario sin fundamento" },
      ...
      { id: 'C', text: "Enfoque Híbrido: Proponer construir solo las APIs públicas como primer paso, posponiendo el marketplace completo para no diluir los recursos del equipo actual.", score: 2, type: "Compromiso (Diluye el foco igual)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cleanup Sprint: Asignar 1 semana completa donde nadie diseña, solo organizan archivos. Detener la producción para limpiar la casa de una vez por todas.", score: 0, type: "Utópico (Nunca se aprueba)" },
      ...
      { id: 'C', text: "Contratación Externa: Contratar un Design Ops Manager o freelance dedicado para que se encargue exclusivamente de ordenar y mantener la biblioteca de archivos.", score: 2, type: "Delegación (Funciona si tienes $)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Re-Educación: Mantener Atomic Design y organizar workshops intensivos para alinear al equipo. Asumes que el problema es la falta de comprensión, no la complejidad del sistema.", score: 0, type: "Dogmático (El problema es el sistema)" },
      ...
      { id: 'C', text: "Anarquía Estructurada: Eliminar la estructura impuesta y permitir que cada squad organice sus componentes como prefiera. Priorizas velocidad sobre consistencia.", score: 0, type: "Caos (Pierde la arquitectura)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Mantener la posición: 'La V2 es superior, eventualmente se acostumbrarán'. Ignorar el feedback y asumir que la resistencia al cambio es temporal y natural en cualquier migración.", score: 0, type: "Arrogante (Churn garantizado)" },
      ...
      { id: 'C', text: "Acceso Legacy: Ofrecer acceso a la V1 legacy en paralelo para quienes no quieran migrar. Es un parche costoso que duplica el mantenimiento y fragmenta la base de usuarios.", score: 2, type: "Parche (Duplica mantenimiento)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hard Sunset: Apagar en la fecha anunciada. Los usuarios tuvieron aviso. Enfocas recursos en el producto futuro, no en el pasado.", score: 0, type: "Corporate Cruelty (Churn 100%)" },
      ...
      { id: 'C', text: "Compensación Monetaria: Ofrecer descuentos agresivos (50%) en el nuevo producto. Intentas comprar la lealtad perdida con ahorro financiero.", score: 2, type: "$$$ (No resuelve el gap de features)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Confrontación Directa: Escribir al CEO explicando que violó el proceso y el Design System. Defiendes la integridad del diseño pero arriesgas tu capital político al avergonzarlo.", score: 2, type: "Valiente (Riesgo político)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Diseñar el Wallet: 'Si Innovación lo pide, lo hacemos'. Desvías recursos críticos del checkout para complacer al directivo, sabiendo que es un desperdicio.", score: 2, type: "Obediente (Desperdicia recursos)" },
      ...
      { id: 'C', text: "Negativa Ideológica: Negarse rotundamente argumentando que blockchain es una moda pasajera. Te posicionas como un obstáculo para la innovación en lugar de un socio estratégico.", score: 1, type: "Conflictivo (Cierra puertas)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hablar de Craft: Explicar que los Design Systems mejoran la consistencia visual y la calidad del código. Apelar a 'best practices' y deuda técnica, aunque no resuene con finanzas.", score: 0, type: "Craft Talk (No convence a Eng)" },
      ...
      { id: 'C', text: "Benchmark Competitivo: 'Airbnb y Uber tienen este rol'. Argumentar que es estándar de industria y que no tenerlo nos deja atrás en la guerra por el talento.", score: 2, type: "Apelación a autoridad (Débil)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Upskilling Forzado: Implementar 'Viernes de Code' obligatorios donde todos aprenden React. Intentas cerrar la brecha percibida por el CTO, aunque distraiga del core skill de diseño.", score: 2, type: "Appeasement (Distrae del core skill)" },
      ...
      { id: 'C', text: "Modelo Híbrido: Proponer contratar 1 Design Engineer que haga handoff técnico mientras los diseñadores puros se enfocan en research y estrategia. Creas un puente técnico sin forzar a todos.", score: 4, type: "Estructural (Resuelve con hiring)" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Construirlo Inmediatamente: $800K/año (18% ARR) justifica cualquier request. Priorizas el cash flow sobre la integridad del roadmap. El concepto de 'pureza de producto' no paga salarios.", score: 2, type: "Revenue-first (Crea deuda técnica)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Diseño Paralelo: Dividir al equipo para prototipar ambas visiones al mismo tiempo. Intentas complacer al ambos pero desperdicias recursos valiosos en trabajo que será descartado.", score: 4, type: "Neutral (Desperdicia recursos)" },
      { id: 'B', text: "Aliarte con uno: Elegir la visión que TÚ crees correcta (ej: B2B) y apostar todo a ella. Es una jugada valiente pero te convierte en enemigo político del otro founder.", score: 2, type: "Valiente (Suicida)" },
