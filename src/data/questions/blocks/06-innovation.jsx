...
export const innovation_questions = [
  ...
  // --- BLOQUE 15: ÉTICA, COMPLIANCE & DARK PATTERNS ---
  {
    ...
    scenario: "Legal exige un modal de cookies bloqueante para cumplir GDPR antes de una auditoría clave en 12 días. Marketing advierte que esto bajará los sign-ups un 14% (-€28K/Q). Sin embargo, fallar la auditoría significa perder un cliente Enterprise de €180K/año.",
    question: "¿Qué implementación propones que balancee compliance legal verificable vs impacto en conversión?",
    options: [
      { id: 'A', text: "Modal Bloqueante Optimizado: Implementas el modal (asegurando el deal de €180K) pero diseñas con mínima fricción y copy claro para mitigar la caída de conversión.", score: 5, type: "Lead (Compliance con UX optimizada)" },
      { id: 'B', text: "Banner Sticky: Usas un banner no bloqueante con 'consentimiento implícito'. Proteges la conversión, pero Legal advierte que hay 30% de riesgo de fallar la auditoría.", score: 2, type: "Grey zone con riesgo legal medible" },
      { id: 'C', text: "Hybrid Contextual: Solo pides consentimiento cuando el usuario intenta una acción clave. Innovador, pero Dev estima 3 semanas (pierdes el deadline).", score: 4, type: "Innovador pero timing arriesgado" }
    ],
    explanation: "Contexto crítico: €180K deal + audit en 12 días elimina opción C (timing). Banner sticky (B) tiene riesgo de fallar audit. Modal bloqueante optimizado (A) garantiza pasar audit y cerrar deal, aceptando un costo medible en conversión."
  },
  {
    id: 'addictive_design_notifications',
    category: "Ética de Diseño",
    icon: <Heart className="w-6 h-6 text-pink-500" />,
    scenario: "VP Growth exige aumentar DAU +28% para la Series B. Propone notificaciones agresivas con 'guilt-tripping' (ej: 'Tu equipo avanza sin ti'). Es la única palanca rápida disponible sin presupuesto de marketing. El equipo debate la ética de la manipulación emocional.",
    question: "¿Qué estrategia de notificaciones propones que balancee engagement necesario vs principios éticos?",
    options: [
      { id: 'A', text: "Persuasive con Límites: Implementas notificaciones de utilidad y social proof, pero eliminas el guilt-tripping directo y añades frequency caps. Balanceas ética y métricas.", score: 4, type: "Pragmático con límites éticos" },
      { id: 'B', text: "Valor Real: Rechazas tácticas emocionales. Solo notificas eventos reales del sistema. Es ético, pero probablemente fallarás el OKR de crecimiento agresivo.", score: 5, type: "Lead (Valor genuino, acepta costo político)" },
      { id: 'C', text: "Full Strategy + Transparency: Implementas todo (incluyendo guilt) pero añades un disclaimer en settings sobre 'filosofía de notificaciones'. Cumples la meta con 'transparency washing'.", score: 2, type: "Utilitarista con transparency washing" }
    ],
    explanation: "No hay respuesta perfecta. Full strategy (C) es ethics washing. Valor puro (B) falla el OKR existencial. Middle ground (A) sacrifica parte del goal pero mantiene guardrails éticos, eliminando lo más tóxico (guilt-tripping)."
  },
  {
    id: 'data_collection_transparency',
    category: "Privacidad & Trust",
    icon: <Lock className="w-6 h-6 text-slate-700" />,
    scenario: "VP Data quiere implementar FullStory (session replay) para ver fricción de UX real. Legal dice que es GDPR-compliant solo con anonimización. El dilema es el consentimiento: Opt-in reduce la data al 20%; Opt-out es legal pero invasivo.",
    question: "¿Qué nivel de tracking implementas considerando insights necesarios vs autonomía del usuario?",
    options: [
      { id: 'A', text: "Opt-Out con Aviso: Activas FullStory por defecto con un banner informativo y opción de desactivar en settings. Maximizas data (87%) asumiendo consentimiento implícito.", score: 4, type: "Pragmático (Legal pero éticamente gris)" },
      { id: 'B', text: "Heatmaps Agregados: Usas herramientas menos invasivas (solo mapas de calor, no video individual). Proteges privacidad pero pierdes capacidad de debuggear casos específicos.", score: 5, type: "Lead (Privacy-conscious, acepta menor visibility)" },
      { id: 'C', text: "Opt-In Estricto: Pides permiso explícito antes de grabar nada. Es lo más ético, pero tendrás data de muy pocos usuarios (sesgo de muestra).", score: 2, type: "Privacy-first con trade-off severo de insights" }
    ],
    explanation: "Dilema entre visibilidad y privacidad. Opt-in puro (C) mata la utilidad estadística. Opt-out (A) explota la inercia. Heatmaps agregados (B) son el balance: mantienes privacidad individual pero pierdes capacidad de debuggear journeys específicos."
  },
  {
  ...
  },
  {
    ...
    scenario: "Debes escalar el equipo para Q2. VP Product quiere 2 Full-Time ($85K/año) para retener conocimiento. CFO prefiere Freelancers (más caros por hora, pero sin compromiso largo). El runway es crítico: solo quedan 7 meses de vida.",
    question: "¿Cómo estructuras el scaling del equipo bajo presión de runway?",
    options: [
      { id: 'A', text: "Full-Time Hires: Contratas permanentes. Apuestas a que la ronda de inversión se cierre. Si no, tendrás que despedir con costo de severance.", score: 2, type: "Apuesta de Runway (Alto riesgo)" },
      { id: 'B', text: "Freelancers Q2: Contratas contractors por 3 meses. Validas la necesidad y mantienes flexibilidad financiera. Si el runway mejora, los internalizas.", score: 5, type: "Lead (Flexibilidad financiera)" },
      { id: 'C', text: "Híbrido: 1 Full-Time + 1 Freelancer. Un punto medio que divide la capacidad y el riesgo, pero no resuelve totalmente ninguno de los dos problemas.", score: 4, type: "Compromiso (Divide capacidades)" }
    ],
    explanation: "Con 7 meses de runway, contratar full-time es una apuesta arriesgada (A). La B mantiene agilidad financiera y valida la necesidad real antes de comprometer burn mensual a largo plazo."
  },
  {
